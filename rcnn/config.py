...
network.resnet.pretrained = 'model/mobilenet_0_25'
...
network.resnet.pretrained = '/data/xxl/Word_model/insightface/detection/retinaface/model/mobilenet_0_25'
...
dataset.retinaface.dataset_path = '/data/xxl/Word_model/insightface/detection/retinaface/data/retinaface'
...
# default e2e
default.prefix = '/data/xxl/Word_model/insightface/detection/retinaface/model'
