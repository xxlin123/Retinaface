...
```
是在mobilenet_0_25这个轻量的backbone的基础上在wflw数据集上训练的

训练的命令如下
CUDA_VISIBLE_DEVICES='0,1,2,3' python -u train.py --prefix ./model/retina --network mnet

导出onnx的代码/data/xxl/Word_model/insightface/detection/retinaface/export_retinaface_onnx.py

测试onnx是否正确的代码/data/xxl/Word_model/insightface/detection/retinaface/retinaface_onnx_infer_test.py
